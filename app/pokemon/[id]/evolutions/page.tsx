...
//         <h1 className="text-2xl font-bold">Evolutions of {data.pokemon.name}</h1>
//         <Evolutions evolutions={data.pokemon.evolutions || []} />
//       </div>
//     );
//   } catch (error) {
//     console.error("GraphQL error:", error);
//     return <p className="text-center text-red-500">Error fetching Pokémon evolutions</p>;
//   }
// }
...
export default async function PokemonEvolutionsPage({ params }: { params: { id: string } }) {
  ...
  try {
    ...
    const evolutions = data.pokemon?.evolutions || [];
